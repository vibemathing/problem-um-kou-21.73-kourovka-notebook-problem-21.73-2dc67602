...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.73-kourovka-notebook-problem-21.73-2dc67602-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.73"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.73-kourovka-notebook-problem-21.73-2dc67602-v1",
      "problem_contract_sha256": "bfcc454f963cd394ada7bfba4a608b4ecd9eac4ce329f5f3ff5fd5740c760a77",
      "problem_id": "problem:um-kou-21.73-kourovka-notebook-problem-21.73-2dc67602",
      "route_id": "route:um-kou-21.73-kourovka-notebook-problem-21.73-2dc67602-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.73-kourovka-notebook-problem-21.73-2dc67602-source-fidelity-01",
      "graph_id": "graph:um-kou-21.73-kourovka-notebook-problem-21.73-2dc67602-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.73-kourovka-notebook-problem-21.73-2dc67602-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.73-kourovka-notebook-problem-21.73-2dc67602-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is the conjugacy problem in $\\operatorname{CT}(\\mathbb Z)$ algorithmically decidable?"
          },
          "statement_sha256": "945bf6c57faf8d8a86dfcf07937cfa5e6cd47841583941c5a9b0f3f097f74eb3"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.73-kourovka-notebook-problem-21.73-2dc67602-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.73-kourovka-notebook-problem-21.73-2dc67602-root",
      "route_id": "route:um-kou-21.73-kourovka-notebook-problem-21.73-2dc67602-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.73-33787aeceb95",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.73"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
